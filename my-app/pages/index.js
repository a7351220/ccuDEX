      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} CCU 
            <br />
            {utils.formatEther(ethBalance)} ETH
            <br />
            {utils.formatEther(lpBalance)} CCU/ETH 流動性證明
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                  {`你會需要${utils.formatEther(addCDTokens)} CCU 代幣`}
                </div>
                <button className={styles.button1} onClick={_addLiquidity}>
                  添加流動性
                </button>
            ...
            <div>
              ...
              <div className={styles.inputDiv}>
                {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                {`你將會得到${utils.formatEther(removeCD)} CCU 和 ${utils.formatEther(removeEther)} ETH`}
              </div>
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>歡迎來到 CCU 交易所!</h1>
          <div className={styles.description}>
            使用 ETH 交換 &#60;&#62; CCU 代幣
          </div>
          <div>
        ...
        <div>
          <img className={styles.image} src="./car.png" />
        </div>
      </div>
